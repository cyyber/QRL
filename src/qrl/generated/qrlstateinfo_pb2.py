...
_HOOKPOOL = _descriptor.Descriptor(
  name='HookPool',
  full_name='qrl.HookPool',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pool', full_name='qrl.HookPool.pool', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['HookPool'] = _HOOKPOOL
...
HookPool = _reflection.GeneratedProtocolMessageType('HookPool', (_message.Message,), dict(
  DESCRIPTOR = _HOOKPOOL,
  __module__ = 'qrlstateinfo_pb2'
  # @@protoc_insertion_point(class_scope:qrl.HookPool)
  ))
_sym_db.RegisterMessage(HookPool)
